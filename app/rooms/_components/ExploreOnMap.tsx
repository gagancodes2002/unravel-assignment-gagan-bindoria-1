...
export default function ExploreOnMap() {
    return (
        <div className="w-full max-w-full sm:max-w-60 md:max-w-full aspect-square max-h-48 sm:max-h-60 md:max-h-55 rounded-md overflow-hidden cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg bg-white shadow-sm">
